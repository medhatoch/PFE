...
public class SessionUtilManager {

    private static final SessionUtilManager instance = new SessionUtilManager();

    private SessionUtilManager() {
    }



    public static void registerUtilisateur(Manager user) {
        setAttribute("user", user);
    }

    public static Manager getConnectedUtilisateur() {
    ...
    public static SessionUtilManager getInstance() {
        return instance;
    }
